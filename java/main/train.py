...
def add_train_args(parser):
    ...
    files.add_argument('--train_t5', nargs='+', type=str,
                       help='Preprocessed train code type 5')
    ...
    files.add_argument('--dev_t5', nargs='+', type=str,
                       help='Preprocessed dev code type 5')
...
def set_defaults(args):
    ...
    if not args.only_test:
        ...
        if num_dataset > 1:
            ...
            if len(args.train_t5) == 1:
                args.train_t5 = args.train_t5 * num_dataset
        ...
        for i in range(num_dataset):
            ...
            train_t5 = os.path.join(data_dir, args.train_t5[i])
            ...
            if not os.path.isfile(train_t5):
                raise IOError('No such file: %s' % train_t5)
            ...
            args.train_src_type5_files.append(train_t5)
    ...
    if num_dataset > 1:
        ...
        if len(args.dev_t5) == 1:
            args.dev_t5 = args.dev_t5 * num_dataset
    ...
    for i in range(num_dataset):
        ...
        dev_t5 = os.path.join(data_dir, args.dev_t5[i])
        ...
        if not os.path.isfile(dev_t5):
            raise IOError('No such file: %s' % dev_t5)
        ...
        args.dev_src_type5_files.append(dev_t5)
...
def main(args):
    ...
    if not args.only_test:
        ...
        for train_src, train_sub, train_src_tag, train_ky, train_t5, train_it, train_is, train_df, train_cf, train_tgt, dataset_name in \
                zip(args.train_src_files, args.train_src_subtoken_files, args.train_src_tag_files, 
                    args.train_src_keyword_files, args.train_src_type5_files, args.train_src_intoken_files, args.train_src_instatement_files, 
            ...
            train_files['src_type5'] = train_t5
    ...
    dev_exs = []
    for dev_src, dev_sub, dev_src_tag, dev_ky, dev_t5 ,dev_it, dev_is, dev_df, dev_cf, dev_tgt, dataset_name in \
            zip(args.dev_src_files, args.dev_src_subtoken_files, args.dev_src_tag_files, 
                args.dev_src_keyword_files, args.dev_src_type5_files, args.dev_src_intoken_files,args.dev_src_instatement_files, 
