...
class Code2NaturalLanguage(object):
    ...
    def update(self, ex):
        ...
        code_keyword = ex['code_keyword']
        code_type5 = ex['code_type5']
        code_intoken = ex['code_intoken']
        code_instatement = ex['code_instatement']
        code_dataflow = ex['code_dataflow']
        #code_controlflow = ex['code_controlflow']
        ...
        if self.use_cuda:
            ...
            if code_keyword is not None:
                code_keyword = code_keyword.cuda(non_blocking=True)
            if code_type5 is not None:
                code_type5 = code_type5.cuda(non_blocking=True)
            if code_intoken is not None:
                code_intoken = code_intoken.cuda(non_blocking=True)
            if code_instatement is not None:
                code_instatement = code_instatement.cuda(non_blocking=True)
            if code_dataflow is not None:
                code_dataflow = code_dataflow.cuda(non_blocking=True)
            #if code_controlflow is not None:
            #    code_controlflow = code_controlflow.cuda(non_blocking=True)
        ...
        net_loss = self.network(code_word_rep=code_word_rep,
                                ...
                                code_type5=code_type5,
                                code_intoken=code_intoken,
                                code_instatement=code_instatement,
