...
class Translator(object):
    ...
    def translate_batch(self, batch_inputs):
        ...
        code_keyword_rep = batch_inputs['code_keyword']
        code_intoken_rep = batch_inputs['code_intoken']
        code_instatement_rep = batch_inputs['code_instatement']
        ...
        if model_name == 'Transformer':
            memory_bank, layer_wise_outputs = encoder(code_rep, code_keyword_rep, code_intoken_rep, code_instatement_rep, code_len)
