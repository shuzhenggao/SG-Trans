...
def prepare_batch(batch, model):
    ...
    code_keyword = batch['code_keyword']
    code_intoken = batch['code_intoken']
    code_instatement = batch['code_instatement']
    ...
    batch_inputs['code_keyword'] = code_keyword
    batch_inputs['code_intoken'] = code_intoken
    batch_inputs['code_instatement'] = code_instatement
...
def main(args):
    ...
    dev_exs = []
    for dev_src, dev_src_tag, dev_src_keyword, dev_src_intoken, dev_src_instatement, dev_tgt, dataset_name in \
        ...
        dev_files['src_keyword'] = dev_src_keyword
        dev_files['src_intoken'] = dev_src_intoken
        dev_files['src_instatement'] = dev_src_instatement
